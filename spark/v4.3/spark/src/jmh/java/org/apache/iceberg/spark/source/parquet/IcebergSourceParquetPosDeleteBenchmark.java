 ...
 *
 * <p>This class uses a dataset with a flat schema. To run this benchmark for spark-4.3: <code>
 *   ./gradlew -DsparkVersions=4.3 :iceberg-spark:iceberg-spark-4.3_2.13:jmh
