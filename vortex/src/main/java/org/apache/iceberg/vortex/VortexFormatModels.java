...
import org.apache.iceberg.formats.FileFormatProvider;
import org.apache.iceberg.formats.FormatModel;

public class VortexFormatModels implements FileFormatProvider {
  @Override
  public Iterable<FormatModel<?, ?>> formatModels() {
    return List.of(
