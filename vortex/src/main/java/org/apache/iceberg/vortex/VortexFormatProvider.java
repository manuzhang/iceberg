...
import org.apache.iceberg.puffin.formats.PuffinFormatProvider;

public class VortexFormatProvider implements PuffinFormatProvider {
  @Override
  public Iterable<CustomFormatModel<?, ?>> formatModels() {
    return List.of(
