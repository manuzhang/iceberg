...
import org.apache.iceberg.puffin.formats.CustomFormatModel;
import org.apache.iceberg.relocated.com.google.common.base.Preconditions;
import org.apache.iceberg.types.Types;

public class VortexFormatModel<D, S, R>
    extends BaseFormatModel<D, S, VortexValueWriter<?>, R, Schema>
    implements CustomFormatModel<D, S> {

  public static final String FORMAT_NAME = "vortex";
  ...
  private static class WriteBuilderWrapper<D, S> implements ModelWriteBuilder<D, S> {
    ...
    private int workerThreads = VortexProperties.WORKER_THREADS_DEFAULT;
    private long splitSize = VortexProperties.WRITE_SPLIT_SIZE_DEFAULT;
    ...
    public ModelWriteBuilder<D, S> set(String property, String value) {
      if (VortexProperties.WRITE_WORKER_THREADS.equals(property)) {
        workerThreads = Integer.parseInt(value);
      } else if (VortexProperties.WRITE_SPLIT_SIZE.equals(property)) {
      ...
      return switch (content) {
        ...
        case POSITION_DELETES, DATA_MANIFEST, DELETE_MANIFEST ->
            throw new UnsupportedOperationException(
                "Content type is not supported for Vortex format: " + content);
      };
    }
  ...
  private static class ReadBuilderWrapper<R, D, S> implements ReadBuilder<D, S> {
    ...
    public ReadBuilder<D, S> set(String key, String value) {
      if (VortexProperties.READ_WORKER_THREADS.equals(key)) {
        workerThreads = Integer.parseInt(value);
      }
      return this;
    }
