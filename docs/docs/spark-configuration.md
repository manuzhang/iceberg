...
| spark.sql.iceberg.parquet.nested-vectorization.enabled | false                                                          | Enables vectorized Parquet reads of struct, list, and map columns (Spark 4.2 only)                                              |
...
| parquet-nested-vectorization-enabled | false | Enables vectorized Parquet reads of struct, list, and map columns (Spark 4.2 only)                                                                                     |
